...
# Toggle to use SQLite locally
USE_SQLITE = os.getenv('DB_USE_SQLITE', 'false').lower() in ('1', 'true', 'yes')

if USE_SQLITE:
    # SQLite URL; store db file in project root
    DATABASE_URL = os.getenv('SQLITE_URL', 'sqlite:///./local.db')
